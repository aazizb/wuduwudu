...
namespace ASP
{
    ...
    #line 1 "..\..\Views\Settlements\DetailGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\Settlements\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/Settlements/DetailGridViewPartial.cshtml")]
    public partial class _Views_Settlements_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_Settlements_DetailGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\Settlements\DetailGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "DetailGridView";
        settings.Caption = IWSLocalResource.LineSettlement;
        settings.SettingsDetail.MasterGridName = "MasterGridViewPartial";
        settings.CallbackRouteValues = new { Controller = "Settlements", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "Settlements", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "Settlements", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "Settlements", Action = "DetailGridViewPartialDelete", transid = Session["transid"] };
        ...
        {
            ((MVCxGridView)sender).ForceDataRowType(typeof(LineSettlement));
        };
    });
...
WriteLiteral("\r\n");
            ...
            #line 353 "..\..\Views\Settlements\DetailGridViewPartial.cshtml"
