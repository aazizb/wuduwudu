...
namespace ASP
{
    ...
    #line 1 "..\..\Views\CustomerInvoices\DetailGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\CustomerInvoices\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/CustomerInvoices/DetailGridViewPartial.cshtml")]
    public partial class _Views_CustomerInvoices_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_CustomerInvoices_DetailGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\CustomerInvoices\DetailGridViewPartial.cshtml"
    ...
    var grid = Html.DevExpress().GridView(settings =>
    {
        ...
        settings.CallbackRouteValues = new { Controller = "CustomerInvoices", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "CustomerInvoices", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "CustomerInvoices", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "CustomerInvoices", Action = "DetailGridViewPartialDelete", transid = Session["transid"] };
...
WriteLiteral("\r\n");
            ...
            #line 353 "..\..\Views\CustomerInvoices\DetailGridViewPartial.cshtml"
