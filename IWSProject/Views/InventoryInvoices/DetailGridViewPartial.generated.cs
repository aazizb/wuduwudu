...
namespace ASP
{
    ...
    #line 1 "..\..\Views\InventoryInvoices\DetailGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\InventoryInvoices\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/InventoryInvoices/DetailGridViewPartial.cshtml")]
    public partial class _Views_InventoryInvoices_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_InventoryInvoices_DetailGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\InventoryInvoices\DetailGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "DetailGridView";
        settings.Caption = IWSLocalResource.LineInventoryInvoice;
        settings.SettingsDetail.MasterGridName = "MasterGridViewPartial";
        settings.CallbackRouteValues = new { Controller = "InventoryInvoices", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "InventoryInvoices", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "InventoryInvoices", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "InventoryInvoices", Action = "DetailGridViewPartialDelete", transid = Session["transid"] };
        ...
        {
            ((MVCxGridView)sender).ForceDataRowType(typeof(LineInventoryInvoice));
        };
    });
...
WriteLiteral("\r\n");
            ...
            #line 356 "..\..\Views\InventoryInvoices\DetailGridViewPartial.cshtml"
