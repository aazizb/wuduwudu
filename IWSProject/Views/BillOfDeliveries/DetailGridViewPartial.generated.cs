...
namespace ASP
{
    ...
    #line 1 "..\..\Views\BillOfDeliveries\DetailGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\BillOfDeliveries\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BillOfDeliveries/DetailGridViewPartial.cshtml")]
    public partial class _Views_BillOfDeliveries_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_BillOfDeliveries_DetailGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\BillOfDeliveries\DetailGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "DetailGridView";
        settings.Caption = IWSLocalResource.lineBillOfDelivery;
        settings.SettingsDetail.MasterGridName = "MasterGridViewPartial";
        settings.CallbackRouteValues = new { Controller = "BillOfDeliveries", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "BillOfDeliveries", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "BillOfDeliveries", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "BillOfDeliveries", Action = "DetailGridViewPartialDelete", transid = Session["transid"] };
        ...
        {
            ((MVCxGridView)sender).ForceDataRowType(typeof(LineBillOfDelivery));
        };
    });
...
WriteLiteral("\r\n");
            ...
            #line 390 "..\..\Views\BillOfDeliveries\DetailGridViewPartial.cshtml"
