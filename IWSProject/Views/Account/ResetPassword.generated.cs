...
namespace ASP
{
    ...
    public partial class _Views_Account_ResetPassword_cshtml : System.Web.Mvc.WebViewPage<IWSProject.Models.ResetPasswordViewModel>
    {
...
Write(Html.DevExpress().TextBoxFor(m => m.Password, s => {
