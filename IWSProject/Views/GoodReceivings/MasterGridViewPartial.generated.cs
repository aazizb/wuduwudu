...
namespace ASP
{
    ...
    #line 2 "..\..\Views\GoodReceivings\MasterGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/GoodReceivings/MasterGridViewPartial.cshtml")]
    public partial class _Views_GoodReceivings_MasterGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_GoodReceivings_MasterGridViewPartial_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 3 "..\..\Views\GoodReceivings\MasterGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "GoodReceiving";
        settings.Caption = IWSLocalResource.GoodReceiving;

        settings.CallbackRouteValues = new { Controller = "goodreceivings", Action = "MasterGridViewPartial" };
        ...
        settings.Columns.Add(column =>
        {
            ...
            column.EditorProperties().ComboBox(combo =>
            {
                ...
                combo.DataSource = IWSLookUp.GetGoodReceivingOID();
            ...
            Html.DevExpress().FormLayout(formLayoutSettings =>
            {
                ...
                formLayoutSettings.Items.Add(i =>
                {
                    ...
                    i.NestedExtension().ComboBox(s =>
                    {
                        ...
                        s.Properties.DataSource = IWSLookUp.GetGoodReceivingOID();
                ...
                btnSettings =>
                {
                    ...
                    btnSettings.ClientSideEvents.Click = "function(s, e){ GoodReceiving.CancelEdit(); }";
                }).Render();
