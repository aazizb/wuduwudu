...
namespace ASP
{
    ...
    #line 2 "..\..\Views\SalesInvoices\MasterGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/SalesInvoices/MasterGridViewPartial.cshtml")]
    public partial class _Views_SalesInvoices_MasterGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_SalesInvoices_MasterGridViewPartial_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 3 "..\..\Views\SalesInvoices\MasterGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "SalesInvoice";
        settings.Caption = IWSLocalResource.SalesInvoice;

        settings.CallbackRouteValues = new { Controller = "SalesInvoices", Action = "MasterGridViewPartial" };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "SalesInvoices", Action = "MasterGridViewPartialAddNew" };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "SalesInvoices", Action = "MasterGridViewPartialUpdate" };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "SalesInvoices", Action = "MasterGridViewPartialDelete" };
        ...
        settings.SetEditFormTemplateContent(c =>
        {
            ...
            {
                formLayoutSettings.Name = "SalesInvoiceEdit";
                ...
                formLayoutSettings.Items.Add(i =>
                {
                    ...
                    i.NestedExtension().ComboBox(s =>
                    {
                        ...
                        s.Properties.DataSource = IWSLookUp.GetSalesInvoiceOID();
                ...
                btnSettings =>
                {
                    ...
                    btnSettings.ClientSideEvents.Click = "function(s, e){ SalesInvoice.UpdateEdit(); }";
                }).Render();
                ...
                btnSettings =>
                {
                    ...
                    btnSettings.ClientSideEvents.Click = "function(s, e){ SalesInvoice.CancelEdit(); }";
                }).Render();
...
WriteLiteral("\r\n");
            ...
            #line 321 "..\..\Views\SalesInvoices\MasterGridViewPartial.cshtml"
