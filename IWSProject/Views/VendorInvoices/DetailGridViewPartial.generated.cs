...
namespace ASP
{
    ...
    #line 1 "..\..\Views\VendorInvoices\DetailGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\VendorInvoices\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/VendorInvoices/DetailGridViewPartial.cshtml")]
    public partial class _Views_VendorInvoices_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_VendorInvoices_DetailGridViewPartial_cshtml()
        {
        }
    ...
    var grid = Html.DevExpress().GridView(settings =>
    {
        ...
        settings.CallbackRouteValues = new { Controller = "VendorInvoices", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "VendorInvoices", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "VendorInvoices", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        ...
        {
            ((MVCxGridView)sender).ForceDataRowType(typeof(LineVendorInvoice));
        };
    });
...
WriteLiteral("\r\n");
            ...
            #line 355 "..\..\Views\VendorInvoices\DetailGridViewPartial.cshtml"
