...
namespace ASP
{
    ...
    #line 2 "..\..\Views\GeneralLedgerOut\MasterGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 3 "..\..\Views\GeneralLedgerOut\MasterGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/GeneralLedgerOut/MasterGridViewPartial.cshtml")]
    public partial class _Views_GeneralLedgerOut_MasterGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_GeneralLedgerOut_MasterGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\GeneralLedgerOut\MasterGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "GeneralLedgerOut";
        settings.Caption = IWSLocalResource.GeneralLedger;

        settings.CallbackRouteValues = new { Controller = "GeneralLedgerOut", Action = "MasterGridViewPartial" };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "GeneralLedgerOut", Action = "MasterGridViewPartialAddNew" };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "GeneralLedgerOut", Action = "MasterGridViewPartialUpdate" };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "GeneralLedgerOut", Action = "MasterGridViewPartialDelete" };
        ...
        settings.SetEditFormTemplateContent(c =>
        {
            ...
            {
                formLayoutSettings.Name = "GeneralLedgerOutEdit";
                ...
                formLayoutSettings.Items.Add(i =>
                {
                    ...
                    i.NestedExtension().ComboBox(s =>
                    {
                        ...
                        s.Properties.DataSource = IWSLookUp.GetGeneralLedgerOutOID();
                ...
                btnSettings =>
                {
                    ...
                    btnSettings.ClientSideEvents.Click = "function(s, e){ GeneralLedgerOut.UpdateEdit(); }";
                }).Render();
                ...
                btnSettings =>
                {
                    ...
                    btnSettings.ClientSideEvents.Click = "function(s, e){ GeneralLedgerOut.CancelEdit(); }";
                }).Render();
...
WriteLiteral("\r\n");
            ...
            #line 291 "..\..\Views\GeneralLedgerOut\MasterGridViewPartial.cshtml"
