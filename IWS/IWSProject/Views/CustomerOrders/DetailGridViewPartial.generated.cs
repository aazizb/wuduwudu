...
namespace ASP
{
    ...
    #line 1 "..\..\Views\CustomerOrders\DetailGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\CustomerOrders\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/CustomerOrders/DetailGridViewPartial.cshtml")]
    public partial class _Views_CustomerOrders_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_CustomerOrders_DetailGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\CustomerOrders\DetailGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "DetailGridView";
        settings.Caption = IWSLocalResource.LineCustomerInvoice;
        settings.SettingsDetail.MasterGridName = "MasterGridViewPartial";
        settings.CallbackRouteValues = new { Controller = "CustomerOrders", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "CustomerOrders", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "CustomerOrders", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "CustomerOrders", Action = "DetailGridViewPartialDelete", transid = Session["transid"] };
        ...
        settings.SetEditFormTemplateContent(templateContent =>
        {
            ...
            .Bind(ViewData["lineCustomerOrders"] ?? templateContent.DataItem)
            .Render();
        });
        #endregion
        ...
        {
            ((MVCxGridView)sender).ForceDataRowType(typeof(LineCustomerInvoice));
        };
    });
...
WriteLiteral("\r\n");
            ...
            #line 337 "..\..\Views\CustomerOrders\DetailGridViewPartial.cshtml"
