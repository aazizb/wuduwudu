...
namespace ASP
{
    ...
    var grid = Html.DevExpress().GridView(settings =>
    {
        ...
        {
            var editItem = ViewData["quantityunit"] != null ? ViewData["quantityunit"] : templateContent.DataItem;
            ...
            Html.DevExpress().FormLayout(formLayoutSettings =>
            {
                ...
                btnSettings =>
                {
                    ...
                    btnSettings.ClientSideEvents.Click = "function(s, e){ QuantityUnitsGridView.UpdateEdit(); }";
                }).Render();
                ...
                btnSettings =>
                {
                    ...
                    btnSettings.ClientSideEvents.Click = "function(s, e){ QuantityUnitsGridView.CancelEdit(); }";
                }).Render();
...
WriteLiteral("\r\n");
            ...
            #line 167 "..\..\Views\QuantityUnits\QuantityUnitsGridViewPartial.cshtml"
