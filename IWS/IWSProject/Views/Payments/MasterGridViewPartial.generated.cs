...
namespace ASP
{
    ...
    #line 1 "..\..\Views\Payments\MasterGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\Payments\MasterGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/Payments/MasterGridViewPartial.cshtml")]
    public partial class _Views_Payments_MasterGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_Payments_MasterGridViewPartial_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 3 "..\..\Views\Payments\MasterGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "Payments";
        settings.Caption = IWSLocalResource.payment;

        settings.CallbackRouteValues = new { Controller = "Payments", Action = "MasterGridViewPartial" };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "Payments", Action = "MasterGridViewPartialAddNew" };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "Payments", Action = "MasterGridViewPartialUpdate" };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "Payments", Action = "MasterGridViewPartialDelete" };
...
WriteLiteral("\r\n");
            ...
            #line 310 "..\..\Views\Payments\MasterGridViewPartial.cshtml"
