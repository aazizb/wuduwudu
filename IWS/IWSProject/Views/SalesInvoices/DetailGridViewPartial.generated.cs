...
namespace ASP
{
    ...
    #line 2 "..\..\Views\SalesInvoices\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/SalesInvoices/DetailGridViewPartial.cshtml")]
    public partial class _Views_SalesInvoices_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_SalesInvoices_DetailGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\SalesInvoices\DetailGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "DetailGridView";
        settings.Caption = IWSLocalResource.LineSalesInvoice;
        settings.SettingsDetail.MasterGridName = "MasterGridViewPartial";
        settings.CallbackRouteValues = new { Controller = "SalesInvoices", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "SalesInvoices", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "SalesInvoices", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "SalesInvoices", Action = "DetailGridViewPartialDelete", transid = Session["transid"] };
        ...
        {
            ((MVCxGridView)sender).ForceDataRowType(typeof(LineSalesInvoice));
        };
    });
...
WriteLiteral("\r\n");
            ...
            #line 335 "..\..\Views\SalesInvoices\DetailGridViewPartial.cshtml"
