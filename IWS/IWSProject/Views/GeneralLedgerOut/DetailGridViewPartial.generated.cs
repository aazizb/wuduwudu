...
namespace ASP
{
    ...
    #line 1 "..\..\Views\GeneralLedgerOut\DetailGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\GeneralLedgerOut\DetailGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/GeneralLedgerOut/DetailGridViewPartial.cshtml")]
    public partial class _Views_GeneralLedgerOut_DetailGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_GeneralLedgerOut_DetailGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\GeneralLedgerOut\DetailGridViewPartial.cshtml"
    ...
    var grid = Html.DevExpress().GridView(settings =>
    {
        ...
        settings.CallbackRouteValues = new { Controller = "GeneralLedgerIn", Action = "DetailGridViewPartial", transid = Session["transid"] };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "GeneralLedgerIn", Action = "DetailGridViewPartialAddNew", transid = Session["transid"] };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "GeneralLedgerIn", Action = "DetailGridViewPartialUpdate", transid = Session["transid"] };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "GeneralLedgerIn", Action = "DetailGridViewPartialDelete", transid = Session["transid"] };
...
WriteLiteral("\r\n");
            ...
            #line 300 "..\..\Views\GeneralLedgerOut\DetailGridViewPartial.cshtml"
