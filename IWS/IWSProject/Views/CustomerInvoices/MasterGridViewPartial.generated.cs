...
namespace ASP
{
    ...
    #line 1 "..\..\Views\CustomerInvoices\MasterGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 2 "..\..\Views\CustomerInvoices\MasterGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/CustomerInvoices/MasterGridViewPartial.cshtml")]
    public partial class _Views_CustomerInvoices_MasterGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_CustomerInvoices_MasterGridViewPartial_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 3 "..\..\Views\CustomerInvoices\MasterGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "CustomerInvoice";
        settings.Caption = IWSLocalResource.CustomerInvoice;

        settings.CallbackRouteValues = new { Controller = "CustomerInvoices", Action = "MasterGridViewPartial" };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "CustomerInvoices", Action = "MasterGridViewPartialAddNew" };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "CustomerInvoices", Action = "MasterGridViewPartialUpdate" };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "CustomerInvoices", Action = "MasterGridViewPartialDelete" };
        ...
        settings.SetEditFormTemplateContent(c =>
        {
            ...
            {
                formLayoutSettings.Name = "CustomerInvoiceEdit";
...
WriteLiteral("\r\n");
            ...
            #line 307 "..\..\Views\CustomerInvoices\MasterGridViewPartial.cshtml"
