...
namespace ASP
{
    ...
    #line 2 "..\..\Views\Settlements\MasterGridViewPartial.cshtml"
    using IWSProject.Content;
    
    #line default
    #line hidden
    
    #line 3 "..\..\Views\Settlements\MasterGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/Settlements/MasterGridViewPartial.cshtml")]
    public partial class _Views_Settlements_MasterGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_Settlements_MasterGridViewPartial_cshtml()
        {
        }
...
WriteLiteral("\r\n");
            ...
            #line 4 "..\..\Views\Settlements\MasterGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "Settlement";
        settings.Caption = IWSLocalResource.Settlement;

        settings.CallbackRouteValues = new { Controller = "Settlements", Action = "MasterGridViewPartial" };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "Settlements", Action = "MasterGridViewPartialAddNew" };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "Settlements", Action = "MasterGridViewPartialUpdate" };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "Settlements", Action = "MasterGridViewPartialDelete" };
        ...
        settings.SetEditFormTemplateContent(c =>
        {
            ...
            {
                formLayoutSettings.Name = "SettlementEdit";
...
WriteLiteral("\r\n");
            ...
            #line 311 "..\..\Views\Settlements\MasterGridViewPartial.cshtml"
