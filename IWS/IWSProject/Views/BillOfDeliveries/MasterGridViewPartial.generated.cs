...
namespace ASP
{
    ...
    #line 2 "..\..\Views\BillOfDeliveries\MasterGridViewPartial.cshtml"
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/BillOfDeliveries/MasterGridViewPartial.cshtml")]
    public partial class _Views_BillOfDeliveries_MasterGridViewPartial_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Views_BillOfDeliveries_MasterGridViewPartial_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 3 "..\..\Views\BillOfDeliveries\MasterGridViewPartial.cshtml"
  
    var grid = Html.DevExpress().GridView(settings =>
    {
        settings.Name = "BillOfDelivery";
        settings.Caption = IWSLocalResource.BillOfDelivery;

        settings.CallbackRouteValues = new { Controller = "BillOfDeliveries", Action = "MasterGridViewPartial" };

        settings.SettingsEditing.AddNewRowRouteValues = new { Controller = "BillOfDeliveries", Action = "MasterGridViewPartialAddNew" };
        settings.SettingsEditing.UpdateRowRouteValues = new { Controller = "BillOfDeliveries", Action = "MasterGridViewPartialUpdate" };
        settings.SettingsEditing.DeleteRowRouteValues = new { Controller = "BillOfDeliveries", Action = "MasterGridViewPartialDelete" };
        ...
        settings.SetEditFormTemplateContent(c =>
        {
            ...
            {
                formLayoutSettings.Name = "BillOfDeliveryEdit";
...
WriteLiteral("\r\n");
            ...
            #line 299 "..\..\Views\BillOfDeliveries\MasterGridViewPartial.cshtml"
